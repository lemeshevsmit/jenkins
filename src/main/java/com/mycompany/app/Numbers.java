...
public class Numbers {
    ...
    protected void calculateBigDecimal(String propMax, String propMin, String propInc) {
    ...
    protected void calculateBigInteger(String propMax, String propMin, String propInc) {
    ...
    protected void calculateDouble(String propMax, String propMin, String propInc) {
    ...
    protected void calculateFloat(String propMax, String propMin, String propInc) {
    ...
    protected void calculateLong(String propMax, String propMin, String propInc) {
    ...
    protected void calculateShort(String propMax, String propMin, String propInc) {
    ...
    protected byte calculateByte(String propMax, String propMin, String propInc) {
    ...
    protected void calculateInt(String propMax, String propMin, String propInc) {
